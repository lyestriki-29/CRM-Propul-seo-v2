-- Script de correction pour le système de réponses
...
-- 4. Corriger la fonction get_reply_message_info selon la structure
SELECT '=== CORRECTION FONCTION ===' as info;

-- Supprimer l'ancienne fonction
DROP FUNCTION IF EXISTS get_reply_message_info(UUID);

-- Créer la fonction avec la bonne table (users ou user_profiles)

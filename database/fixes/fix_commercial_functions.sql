-- =====================================================
-- CORRECTION DES FONCTIONS COMMERCIALES MANQUANTES
-- =====================================================

-- 1. Créer la fonction get_commercial_stats manquante
...
BEGIN
  ...
  LEFT JOIN (
    ...
    WHERE calleur_id = input_calleur_id
    GROUP BY calleur_id
...
-- 2. Créer la fonction get_commercial_kpis
...
-- 3. Créer la fonction get_commercial_leaderboard
...
-- 4. Créer la fonction get_commercial_chart_data
...
-- 5. S'assurer que RLS est désactivé pour éviter les erreurs 403

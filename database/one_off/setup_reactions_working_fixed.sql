-- Script de réactions corrigé avec la bonne syntaxe SQL
...
-- 3. Recréer la table des réactions avec la contrainte UNIQUE correctement placée
CREATE TABLE message_reactions (
  ...
  -- Contrainte UNIQUE : un utilisateur ne peut réagir qu'une seule fois avec le même emoji à un message

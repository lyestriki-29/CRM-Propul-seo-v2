-- =====================================================
-- FONCTIONS DE SYNCHRONISATION DES ACTIVITÉS
-- =====================================================
...
BEGIN
  ...
  SELECT * INTO record_data FROM crm_bot_one_records WHERE id = activity_record.record_id;
  SELECT id INTO client_id 
  FROM clients 
  WHERE name = COALESCE(record_data.data->>'Nom de l''entreprise', record_data.data->>'Nom contact');
...
SELECT 
  'FONCTIONS D''ACTIVITÉS CRÉÉES' as status,

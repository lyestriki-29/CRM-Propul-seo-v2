...
export const MOCK_BRIEFS: Record<string, ProjectBrief> = {
  ...
  'proj-test-siteweb': {
    id: 'brief-test-sw', project_id: 'proj-test-siteweb', status: 'validated' as const,
    objective: 'Refonte site vitrine + SEO local pour boulangerie artisanale. Système de réservation en ligne.',
    target_audience: 'Clients de quartier 25-60 ans, familles, Google Maps.',
    pages: '5 pages : Accueil, Menu/Produits, Réservation, À propos, Contact',
    techno: 'WordPress + WooCommerce. Hébergement OVH.',
    design_references: 'Ambiance chaleureuse, tons crème/brun. Ref : maison-kayser.com',
    notes: 'Client souhaite gérer les produits lui-même. Formation WP incluse.',
    created_at: now, updated_at: now,
  },
  'proj-test-erp': {
    id: 'brief-test-erp', project_id: 'proj-test-erp', status: 'validated' as const,
    objective: 'ERP sur-mesure pour gestion logistique : flotte véhicules, planning chauffeurs, suivi colis temps réel.',
    target_audience: 'Responsables logistique, dispatchers, direction TransportPro (15 utilisateurs).',
    pages: 'Modules : Dashboard, Gestion flotte, Planning, Suivi colis, Facturation, Admin',
    techno: 'Laravel + Vue.js, PostgreSQL, hébergement dédié OVH.',
    design_references: 'Interface sobre et fonctionnelle. Ref : fleetio.com, routific.com',
    notes: 'Contrainte : intégration API Chronopost + DHL. SSO avec Google Workspace client.',
    created_at: now, updated_at: now,
  },
  'proj-test-comm': {
    id: 'brief-test-comm', project_id: 'proj-test-comm', status: 'draft' as const,
    objective: 'Gestion réseaux sociaux Instagram + LinkedIn. Objectif : +500 abonnés en 6 mois.',
    target_audience: 'Consommateurs bio 25-45 ans, locavores, restaurants partenaires.',
    pages: '8 posts/mois Instagram, 4 posts/mois LinkedIn, 2 reels/mois',
    techno: 'Canva Pro, Later (scheduling), Google Analytics.',
    design_references: 'Tons verts/naturels, photos produits lifestyle. Ref : biocoop, naturalia',
    notes: 'Client fournit les produits pour shootings. Shooting mensuel inclus.',
    created_at: now, updated_at: now,
  },
}

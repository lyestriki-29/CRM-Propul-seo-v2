...
import type { ClientPostAssetRow } from '../../../types/supabase-types';

interface AssetManagerClientProps {
  assets: ClientPostAssetRow[];
...
export function AssetManagerClient({ assets, onUpload, onAddExternal, onDelete, loading }: AssetManagerClientProps) {

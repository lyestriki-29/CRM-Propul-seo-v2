...
import type { ClientPostCommentRow } from '../../../types/supabase-types';

interface CommentThreadClientProps {
  comments: ClientPostCommentRow[];
...
export function CommentThreadClient({ comments, currentUserId, onAddComment, onDeleteComment, loading }: CommentThreadClientProps) {

...
import type { PostRow, PostStatus, KanbanColumn } from '../types';

interface UsePostDragDropClientProps {
...
export function usePostDragDropClient({ initialPosts, onUpdate }: UsePostDragDropClientProps) {

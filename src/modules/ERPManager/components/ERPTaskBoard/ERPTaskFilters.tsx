...
import type { ERPTaskFiltersState, ERPTaskView } from './useERPTasks'
import type { CommTaskPriority, CommTaskStatus, ProjectV2, StatusERP } from '../../../../types/project-v2'
import { PRIORITY_CONFIG, STATUS_CONFIG } from './erpTaskConfig'

type ERPProject = ProjectV2 & { erp_status: StatusERP }

interface ERPTaskFiltersProps {
  filters: ERPTaskFiltersState
  view: ERPTaskView
  projects: ERPProject[]
  currentDate: Date
  onFiltersChange: (f: ERPTaskFiltersState) => void
  onViewChange: (v: ERPTaskView) => void
  onPrev: () => void
  onNext: () => void
  onToday: () => void
  onNewTask: () => void
...
export function ERPTaskFilters({

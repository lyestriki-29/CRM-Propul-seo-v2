...
import { ProjectStatusBadge } from '../../ProjectsManager/components/ProjectStatusBadge'
import { PrestaList } from '../../ProjectsManager/components/PrestaBadge'
import { CompletionScore } from '../../ProjectsManager/components/CompletionScore'
import { DeadlineBadge } from '../../ProjectsManager/components/DeadlineBadge'
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <MetricCard
          ...
          sub={project.end_date ? <DeadlineBadge endDate={project.end_date} /> as unknown as string : '—'}
        />
      </div>

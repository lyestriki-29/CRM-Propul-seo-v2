...
import { PRIORITY_CONFIG, projectAbbr } from './siteWebTaskConfig'

interface SiteWebTaskChipProps {
  task: CommTask
...
export function SiteWebTaskChip({ task, onClick, isDragging, style, dragHandleProps }: SiteWebTaskChipProps) {

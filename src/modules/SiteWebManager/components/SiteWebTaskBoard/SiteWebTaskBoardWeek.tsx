...
import { PRIORITY_CONFIG } from './siteWebTaskConfig'
import { cn } from '@/lib/utils'

interface SiteWebTaskBoardWeekProps {
  tasks: CommTask[]
  currentDate: Date
...
export function SiteWebTaskBoardWeek({ tasks, currentDate, onMoveTask, onClickTask, onDateClick }: SiteWebTaskBoardWeekProps) {

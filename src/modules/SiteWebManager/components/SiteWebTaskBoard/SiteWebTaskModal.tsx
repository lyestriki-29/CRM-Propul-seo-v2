...
import type { CommTask, CommTaskStatus, CommTaskPriority, ProjectV2, StatusSiteWeb } from '../../../../types/project-v2'

type SiteWebProject = ProjectV2 & { sw_status: StatusSiteWeb }

interface SiteWebTaskModalProps {
  open: boolean
  task: CommTask | null
...
export function SiteWebTaskModal({ open, task, projects, defaultDate, onSave, onDelete, onClose }: SiteWebTaskModalProps) {

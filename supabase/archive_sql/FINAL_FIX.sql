-- =====================================================
-- CORRECTION FINALE - SUPPRESSION DES CONTRAINTES
-- =====================================================
...
ALTER TABLE commercial_users DROP CONSTRAINT IF EXISTS commercial_users_user_id_fkey;
ALTER TABLE commercial_users DROP CONSTRAINT IF EXISTS commercial_users_email_key;

-- 2. CRÉER L'UTILISATEUR DIRECTEMENT (SANS CONTRAINTE USER_ID)

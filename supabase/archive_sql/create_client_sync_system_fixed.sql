-- =====================================================
-- SYSTÈME DE SYNCHRONISATION CLIENTS - VERSION CORRIGÉE
-- =====================================================
...
BEGIN
  ...
  -- Extraire les informations du JSONB avec des variables intermédiaires
...
BEGIN
  ...
  entreprise_name := record_data.data->>'Nom de l''entreprise';
  contact_name := record_data.data->>'Nom contact';
  client_name := COALESCE(entreprise_name, contact_name);
...
BEGIN
  ...
  -- Construire le nom du client
  client_name := COALESCE(record_data.company_name, record_data.contact_name);

-- =====================================================
-- CRÉATION DES TABLES D'ACTIVITÉS POUR BOT ONE ET BYW (CORRIGÉ)
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_crm_bot_one_activities_record_id ON public.crm_bot_one_activities(bot_one_record_id);
...
CREATE INDEX IF NOT EXISTS idx_crm_byw_activities_record_id ON public.crm_byw_activities(byw_record_id);
...
SELECT 
  'TABLES D''ACTIVITÉS CRÉÉES (CORRIGÉ)' as status,

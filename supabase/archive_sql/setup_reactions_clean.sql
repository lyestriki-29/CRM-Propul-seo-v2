-- Script de nettoyage et recréation du système de réactions
-- À exécuter dans l'éditeur SQL de Supabase

-- 1. Supprimer la table des réactions si elle existe (cela supprimera aussi les politiques)
...
-- 3. Recréer la table des réactions proprement
...
SELECT 'Système de réactions recréé avec succès !' as status;
